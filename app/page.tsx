...
const basePath = '/cnno-1775720389401';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft high-quality, artisanal sweet rolls that bring warmth and comfort to our customers, while fostering a sense of community and excellence in the baking industry.</p>
                </div>
                <div className="space-y-2">
